...
Elles sont disponibles sous plusieurs formes car les optimisations du compilateur (MSVC ici) ont été activées dans leur niveau maximal (O2).
...
Néanmoins, cela ne fonctionne que sous Linux avec GCC et Windows avec MSVC, mais pas sous Mac OS X avec Clang.
